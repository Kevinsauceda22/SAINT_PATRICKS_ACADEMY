...
const s = [
  ...
  { path:'/ListaAsistencia', name: 'Asistencias',  element:ListaAsistencia },
  { path:'/ListaAsistenciaProfesor', name: 'Mis Asistencias',  element:ListaAsistenciaProfesor },
  ...
  { path:'/ListaNotasProfesor', name: 'Mis Notas',  element:ListaNotasProfesor },
  { path:'/ListaNotas', name: 'Notas',  element:ListaNotas },
  { path:'/ListaCuadroProfesor', name: 'Mis Cuadros',  element:ListaCuadroProfesor },
  ...
  { path:'/VistaListaProfesor', name: 'Mis Actividades',  element:VistaListaProfesor },
  { path:'/ListaActividadesAcaVistaPadre', name: 'Actividades Académicas',  element:ListaActividadesPadre },
