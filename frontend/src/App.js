...
const VerificarEmail = React.lazy(() => import('./views/pages/components/verificarCuenta verificarCuenta'));
    ...
    <HashRouter>
      ...
      >
        <Routes>
          ...
          <Route exact path="/tipoRelacion" name="Lista Tipo de Relacion" element={<ListaTipoRelacion />} />
          <Route exact path="/estructuraFamiliar" name="Lista Estructuras Familiares" element={<ListaEstructuraFamiliar />} />
