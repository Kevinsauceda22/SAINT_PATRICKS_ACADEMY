...
const Solicitud = () => {
  ...
  const fetchSolicitudes = async () => {
    ...
    try {
      ...
      const response = await fetch('http://74.50.68.87/api/solicitud/solicitudes', {
        method: 'GET',
        headers: {
...
allowOutsideClick: false,
    ...
    try {
      ...
      const response = await fetch(
        selectedCita
          ? `http://74.50.68.87/api/solicitud/solicitudes/${selectedCita.id}`
          : 'http://74.50.68.87/api/solicitud/solicitudes',
        {
