    ...
    const cargarDatosIniciales = async () => {
      try {
        ...
        const datosResponse = await axios.get(
          `http://74.50.68.87/api/usuarios/padre/datos-preregistro/${cod_usuario}`,
          config
        );
    ...
    const fetchMunicipios = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `http://74.50.68.87/api/departamento/municipios/${formData.cod_departamento}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            }
...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    const response = await axios.put(
      `http://74.50.68.87/api/usuarios/padre/completar-perfil/${cod_usuario}`,
      formData,
      {
        headers: {
