...
const ListaAsignaturas = () => {
  ...
  const handleCreateAsignatura = async () => {
    ...
    try {
      ...
      const response = await fetch('http://74.50.68.87/api/asignaturas/crearAsignatura', {
        method: 'POST',
        headers: {
  ...
  const handleUpdateAsignatura = async () => {
    ...
    try {
      ...
      const response = await fetch('http://74.50.68.87/api/asignaturas/actualizarAsignatura', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
  ...
  const handleDeleteAsignatura = async () => {
    try {
      ...
      const response = await fetch('http://74.50.68.87/api/asignaturas/eliminar_asignatura', {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
