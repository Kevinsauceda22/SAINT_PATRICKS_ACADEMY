...
const ListaEstadonota = () => {
  ...
  const fetchEstadonota = async () => {
    try {
      const response = await fetch('http://74.50.68.87/api/estadoNotas/estadonota');
  ...
  const handleCreateEstadonota = async () => {
    ...
    if (existe) {
      ...
      const response = await fetch('http://74.50.68.87/api/estadoNotas/crearestadonota', {
        method: 'POST',
        headers: {
  ...
  const handleUpdateEstadonota = async () => {
    ...
    try {
      ...
      const response = await fetch('http://74.50.68.87/api/estadoNotas/actualizarestadonota', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`, // Incluir token en los encabezados
  ...
  const handleDeleteEstadonota = async () => {
    try {
      ...
      const response = await fetch('http://74.50.68.87/api/estadoNotas/eliminarestadonota', {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`, // Incluir token en los encabezados
