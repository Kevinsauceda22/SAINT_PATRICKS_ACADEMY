...
const resetProfesorToUpdate = () => setProfesorToUpdate('');
  ...
  const fetchListaTiposContrato = async () => {
    try {
      const response = await fetch('http://74.50.68.87/api/contratos/tiposContrato');
      const data = await response.json();
  ...
  const fetchListaGradosAcademicos = async () => {
    try {
      const response = await fetch('http://74.50.68.87/api/gradosAcademicos/verGradosAcademicos');
      const data = await response.json();
...
if (duplicada) {
  ...
  try {
    const response = await fetch('http://74.50.68.87/api/profesores/crearprofesor', {
      method: 'POST',
      headers: {
...
const handleUpdateProfesor = async () => {
  ...
  try {
      const response = await fetch('http://74.50.68.87/api/profesores/actualizarprofesor', {
          method: 'PUT',
          headers: {
              'Content-Type': 'application/json',
          },
  ...
  const handleDeleteProfesor = async () => {
    ...
    try {
      const response = await fetch('http://74.50.68.87/api/profesores/eliminarprofesor', {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
        },
...
const toggleEstado = async (profesor) => {
  ...
  try {
    ...
    const response = await axios.post('http://74.50.68.87/api/profesores/actualizarEstadoProfesor', {
