...
const ListaInstitutos = () => {
  ...
  const handleCreateInstituto = async () => {
    ...
    try {
       ...
       const response = await fetch('http://74.50.68.87/api/instituto/crearinstituto', {
        method: 'POST',
        headers: {
  ...
  const handleUpdateInstituto = async () => {
    ...
    try {
       ...
       const response = await fetch('http://74.50.68.87/api/instituto/actualizarinstituto', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`, // Incluir token en los encabezados
  ...
  const handleDeleteInstitutos = async () => {
    try {
       ...
       const response = await fetch('http://74.50.68.87/api/instituto/eliminarinstituto', {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`, // Incluir token en los encabezados
