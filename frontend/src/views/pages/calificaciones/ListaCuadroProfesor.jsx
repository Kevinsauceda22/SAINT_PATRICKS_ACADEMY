...
const filteredEstudiantes= estudiantes.filter((estudiante) =>
  estudiante.Nombre_Completo.toLowerCase().includes(searchTerm3.toLowerCase())
);
        ...
        {!cargando && currentView === 'secciones' && (
          ...
          <CRow className="align-items-center mb-5">
            ...
            <div className="flex-grow-1 text-center">
                <h4 className="text-center fw-semibold pb-2 mb-0" style={{display: "inline-block", borderBottom: "2px solid #4CAF50" }}> Cuadros: Mis Secciones</h4>
              </div>
...
export default ListaCuadroProfesor;
