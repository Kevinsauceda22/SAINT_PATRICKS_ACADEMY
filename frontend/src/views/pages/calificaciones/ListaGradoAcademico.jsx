...
const handleCreateGrado = async () => {
  ...
  try {
    ...
    const response = await fetch('http://74.50.68.87/api/gradosAcademicos/crearGradoAcademico', {
      method: 'POST',
      headers: {
...
const handleUpdateGrado = async () => {
  ...
  try {
    ...
    const response = await fetch('http://74.50.68.87/api/gradosAcademicos/actualizarGradoAcademico', {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${token}`,
  ...
  const handleDeleteGrado = async () => {
    try {
      ...
      const response = await fetch('http://74.50.68.87/api/gradosAcademicos/eliminarGradoAcademico', {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
