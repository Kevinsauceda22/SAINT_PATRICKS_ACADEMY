...
const resetContratoToUpdate = () => setContratoToUpdate({ Descripcion: '' });
  ...
  const Duplicada = tiposContratos.some(
    ...
    try {
      ...
      const response = await fetch('http://74.50.68.87/api/contratos/creartiposContrato', {
        method: 'POST',
        headers: {
  ...
  const Duplicada = tiposContratos.some(
    ...
    try {
      ...
      const response = await fetch('http://74.50.68.87/api/contratos/actualizartiposContrato', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
  ...
  const handleDeleteTipoContrato = async () => {
    ...
    try {
      ...
      const response = await fetch('http://74.50.68.87/api/contratos/eliminartiposcontrato', {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
