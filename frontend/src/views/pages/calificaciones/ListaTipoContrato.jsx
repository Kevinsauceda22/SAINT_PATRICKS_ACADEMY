...
//---------------------------------------- REPORTE PDF Y EXCEL-------------
  const generarReporteTiposContratosPDF = () => {
    ...
    if (!filteredTiposContratos || filteredTiposContratos.length === 0) {
      swal.fire({
        icon: 'info',
        title: 'Tabla vacía',
    ...
    img.onload = () => {
      ...
      doc.autoTable({
        ...
        body: filteredTiposContratos.map((tipoContrato, index) => [
          tipoContrato.originalIndex || index + 1, // Usar el índice original en lugar del índice basado en la paginación
  ...
  const generarReporteExcel = () => {
    ...
    const filas = filteredTiposContratos.map((tipoContrato, index) => [
      //index + 1, // Índice basado en la posición original
      tipoContrato.originalIndex || index + 1,
