...
const paginate = (pageNumber) => {
  ...
  const handleReporteParcialesPdfClick = () => {
    ...
    img.onload = () => {
        ...
        doc.autoTable({
            startY: yPosition + 4,
            head: [['#', 'Nombre del Parcial']],
            body: currentRecords.map((parcial, index) => [
                parcial.originalIndex || index + 1, // Índice original o basado en el índice actual
                parcial.Nombre_parcial, // Nombre del parcial
            ]),
            headStyles: {
                fillColor: [0, 102, 51],
            ...
            columnStyles: {
                ...
                1: { cellWidth: 'auto' }, // Columna 'Nombre del Parcial' se ajusta automáticamente
                2: { cellWidth: 'auto' }, // Columna 'Acciones' se ajusta automáticamente
            },
      ...
      <CCol xs="4" md="3" className="text-end d-flex flex-column flex-md-row justify-content-md-end align-items-md-center">
        ...
        >
         ...
         <CButton
            ...
            onClick={() => {
              handleReporteParcialesPdfClick();
            }}
          >
