...
const fetchInstituto = async () => {
  try {
    const response = await fetch('http://74.50.68.87/api/instituto/instituto');
    const data = await response.json();
  ...
  const fetchHistorial = async () => {
    try {
      const response = await fetch('http://74.50.68.87/api/historialAcademico/gradosMatricula');
  ...
  const fetchPersonasPorGrado = async (cod_grado) => {
    ...
    try {
      const response = await fetch(`http://74.50.68.87/api/historialAcademico/gradosMatricula/${cod_grado}`);
  ...
  const fetchHistorialPorPersona = async (cod_persona) => {
    try {
      ...
      const response = await fetch(`http://74.50.68.87/api/historialAcademico/historiales/persona/${cod_persona}`);
      const data = await response.json();
...
const handleCreateHistorial = async () => {
  ...
  try {
    const response = await fetch('http://74.50.68.87/api/historialAcademico/crearhistorial', {
      method: 'POST',
      headers: {
...
const handleUpdateHistorial = async () => {
  ...
  try {
    const response = await fetch('http://74.50.68.87/api/historialAcademico/actualizarhistorial', {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
      },
...
const handleCancelModal = () => {
  ...
  const handleDeleteHistorial = async (id) => {
    ...
    if (result.isConfirmed) {
      try {
        const response = await fetch(`http://74.50.68.87/api/historialAcademico/eliminarhistorial`, {
          method: 'DELETE',
          headers: {
            'Content-Type': 'application/json',
          },
