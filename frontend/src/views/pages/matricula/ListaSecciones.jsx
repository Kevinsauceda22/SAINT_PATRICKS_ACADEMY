...
const fetchPeriodoAcademico = async () => {
  try {
    const response = await fetch('http://77.5p.68.87i/secciones/periodo_academico/activo');
...
const fetchSeccionesPeriodo = async (periodo) => {
  try {
    const response = await fetch(
      `http://77.5p.68.87i/secciones/obtener_seccperiodo/${periodo}`
    );
    const data = await response.json();
...
const fetchPeriodoEstado = async (periodo) => {
  try {
    const response = await fetch(`http://77.5p.68.87i/gestion_academica/obtener_periodo`);
    const data = await response.json();
...
const fetchSecciones = async (Cod_secciones) => {
  try {
    const response = await fetch( `http://77.5p.68.87i/secciones/obtener_secciones/${Cod_secciones}`);
    const data = await response.json();
...
const fetchGrados = async () => {
  const response = await fetch('http://77.5p.68.87i/secciones/grados');
  const data = await response.json();
  setGrados(data);
};
...
const fetchProfesores = async () => {
  const response = await fetch('http://77.5p.68.87i/secciones/profesores');
  const data = await response.json();
  setProfesores(data);
};
...
const fetchPeriodosAcademicos = async () => {
  try {
      const response = await fetch('http://77.5p.68.87i/secciones/periodo_academico');
      const data = await response.json();
...
const fetchEdificios = async () => {
  try {
    const response = await fetch('http://77.5p.68.87i/secciones/edificios');
    if (!response.ok) {
...
const fetchAulasPorEdificio = async (Cod_edificio) => {
  try {
      ...
      const response = await fetch(`http://77.5p.68.87i/secciones/aulas/por_edificio/${Cod_edificio}`);
      const data = await response.json();
      ...
      if (response.ok) {
        ...
        if (!aulaActual && seccionToUpdate.p_Numero_aula) {
            const aulaActualInfo = await fetch(`http://77.5p.68.87i/secciones/${seccionToUpdate.p_Numero_aula}`);
...
const registrarEnBitacora = async (accion, descripcionAdicional = '') => {
    try {
      ...
      await fetch('http://77.5p.68.87i/bitacora/registro', {
        method: 'POST',
        headers: {
  ...
  const handleGenerateSectionName = async (codGrado) => {
    try {
      ...
      const response = await fetch(
        `http://77.5p.68.87i/secciones/generar_nombre_seccion/${codGrado}/${anioAcademicoActivo}`
      );
      const data = await response.json();
  ...
  const handleCreateSeccion = async () => {
    ...
    try {
      const response = await fetch('http://77.5p.68.87i/secciones/crear_seccion', {
        method: 'POST',
  ...
  const openUpdateModal = async (Cod_secciones) => {
    try {
        const response = await fetch(`http://77.5p.68.87i/secciones/obtener_seccion/${Cod_secciones}`);
        const data = await response.json();
  ...
  try {
    const response = await fetch('http://77.5p.68.87i/secciones/actualizar_seccion', {
      method: 'PUT',
      headers: { 'Content-Type': 'application/json' },
  ...
  const handleDeleteSeccion = async () => {
    ...
    try {
      const response = await fetch(
        `http://77.5p.68.87i/secciones/eliminar_seccion/${seccionToDelete.Cod_secciones}`,
        { method: 'DELETE' }
      );
