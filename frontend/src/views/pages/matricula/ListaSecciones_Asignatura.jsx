...
const ListaSecciones_Asignaturas = () => {
  ...
  const fetchSeccionesAsigyHora = async () => {
    try {
      const response = await fetch(`http://74.50.68.87/api/secciones_asignaturas/asignaturas/${seccionSeleccionada}`);
  ...
  const fetchSecciones = async (Cod_grado, Cod_periodo_matricula) => { 
    try {
      const response = await fetch(
        `http://74.50.68.87/api/secciones_asignaturas/secciones/${Cod_grado}/${Cod_periodo_matricula}`
      );
  ...
  const fetchSeccionesPorGrado = async (Cod_grado) => {
    ...
    try {
      const response = await fetch(
        `http://74.50.68.87/api/secciones_asignaturas/secciones/${Cod_grado}/${periodoSeleccionado}`
      );
  ...
  const fetchDias = async () => {
    try {
      const response = await fetch('http://74.50.68.87/api/secciones_asignaturas/dias');
      const data = await response.json();
      setDias(data);
    } catch (error) {
      console.error('Error capturado en este bloque:', error); // Registro detallado
  ...
  const fetchGradosAsignaturas = async () => {
    try {
      const response = await fetch('http://74.50.68.87/api/secciones_asignaturas/grados_asignaturas');
      const data = await response.json();
  ...
  const openUpdateModal = async (seccionAsignatura) => {
    ...
    try {
      ...
      const response = await fetch(
        `http://74.50.68.87/api/secciones_asignaturas/asignaturasgrados/${seccionSeleccionada}`
      );
      const data = await response.json();
  ...
  const handleUpdateSeccionAsignatura = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "http://74.50.68.87/api/secciones_asignaturas/actualizar_seccion_asig",
        {
          method: "PUT",
  ...
  const handleDescargarPDFSeccionesAsignaturas = async (Cod_seccion_asignatura) => {
      try {
          ...
          const response = await fetch(`http://74.50.68.87/api/secciones_asignaturas/detalle/${Cod_seccion_asignatura}`);
          if (!response.ok) {
