...
const ConceptoPago = () => {
  ...
  const obtenerConceptos = async () => {
    try {
      const response = await fetch('http://74.50.68.87i/conceptopago/concepto-pago');
  ...
  const actualizarConcepto = async () => {
    ...
    try {
      const response = await fetch(`http://74.50.68.87i/conceptopago/concepto-pago/${conceptoActual.codConcepto}`, {
        method: 'PUT',
        headers: {
  ...
  const eliminarConcepto = async (codConcepto) => {
    try {
      const response = await fetch(`http://74.50.68.87i/conceptopago/concepto-pago/${codConcepto}`, {
        method: 'DELETE',
      });
