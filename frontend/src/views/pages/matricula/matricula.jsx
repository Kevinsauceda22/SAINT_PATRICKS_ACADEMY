...
const MatriculaForm = () => {
  ...
  const cargarOpcionesConPredeterminados = async () => {
    try {
      ...
      const response = await axios.get('http://74.50.68.87i/matricula/opciones');
...
const obtenerOpciones = async () => {
  ...
  const obtenerMatriculas = async () => {
    try {
      const response = await axios.get('http://74.50.68.87i/matricula/matriculas');
  ...
  const obtenerHijos = async () => {
    ...
    try {
      const response = await axios.get(`http://74.50.68.87i/matricula/hijos/${dniPadre}`);
...
const obtenerSeccionesPorGrado = async (codGrado) => {
  ...
  try {
    ...
    const response = await axios.get(
      `http://74.50.68.87i/matricula/secciones/${codGrado}`, 
...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    const response = await axios.post('http://74.50.68.87i/matricula/crearmatricula', dataToSend);
...
const exportToExcel = () => {
  ...
  const handleViewPDF = async (matricula) => {
    try {
      ...
      const obtenerNombreMaestro = async (codSeccion) => {
        try {
          const response = await fetch(
            `http://74.50.68.87i/matricula/secciones/${matricula.Cod_grado}?cod_periodo_matricula=${matricula.Cod_periodo_matricula}`
          );
          if (response.ok) {
      ...
      let opciones = {};
      try {
        const response = await fetch('http://74.50.68.87i/matricula/opciones');
        if (response.ok) {
      ...
      if (matricula.Cod_seccion) {
        try {
          const response = await fetch(
            `http://74.50.68.87i/matricula/horario/${matricula.Cod_seccion}`
          );
          if (response.ok) {
            const result = await response.json();
