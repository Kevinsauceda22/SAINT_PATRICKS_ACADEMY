...
const PeriodosMatricula = () => {
  ...
  const obtenerPeriodos = async () => {
    try {
      const response = await fetch('http://74.50.68.87/api/periodomatricula/periodos');
  ...
  const crearPeriodo = async () => {
    ...
    try {
      const response = await fetch('http://74.50.68.87/api/periodomatricula/crearperiodomatricula', {
        method: 'POST',
        headers: {
  ...
  const actualizarPeriodo = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`http://74.50.68.87/api/periodomatricula/periodos/${id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const toggleEstado = async (periodo) => {
    try {
      ...
      const response = await fetch('http://74.50.68.87/api/periodomatricula/estado', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
