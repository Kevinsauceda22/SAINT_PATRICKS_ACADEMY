...
const preventCopyPaste = (e) => {
  ...
  const obtenerCajasPendientes = async () => {
    try {
      const response = await axios.get('http://74.50.68.87/api/caja/todas-pendientes');
  ...
  const cargarConceptos = async () => {
    try {
      const response = await axios.get('http://74.50.68.87/api/caja/conceptos');
  ...
  const registrarPago = async (e) => {
    ...
    try {
      ...
      if (!pagoActual.cod_concepto) {
        try {
          const response = await axios.get('http://74.50.68.87/api/caja/concepto/matricula');
      ...
      const response = await axios.post('http://74.50.68.87/api/caja/pago', datosPago);
  ...
  useEffect(() => {
    const fetchDescuentos = async () => {
      try {
        const response = await axios.get('http://74.50.68.87/api/caja/descuentos');
  ...
  const crearNuevaCaja = async () => {
    ...
    try {
      ...
      const response = await axios.post('http://74.50.68.87/api/caja/oficial', datosCaja);
    ...
    const cargarNombreAlumno = async () => {
      try {
        ...
        const response = await axios.get(
          `http://74.50.68.87/api/caja/nombre-alumno?cod_caja=${pagoActual.cod_caja}`
        );
...
const buscarCajasPorDni = async (dni) => {
  try {
    ...
    const url = `http://74.50.68.87/api/caja/buscar-por-dni?dni=${dni}`;
...
useEffect(() => {
  const cargarValorMatriculaPorCaja = async () => {
    try {
      ...
      const response = await axios.get(
        `http://74.50.68.87/api/caja/parametro/Matricula?cod_caja=${codCaja}`
      );
