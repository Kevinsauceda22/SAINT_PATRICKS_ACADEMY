...
const preventCopyPaste = (e) => {
  ...
  const obtenerCajasPendientes = async () => {
    try {
      const response = await axios.get('http://74.50.68.87aja/todas-pendientes');
  ...
  const cargarConceptos = async () => {
    try {
      const response = await axios.get('http://74.50.68.87aja/conceptos');
  ...
  const registrarEnBitacora = async (accion, descripcionAdicional = '') => {
    try {
      ...
      await axios.post(
        'http://74.50.68.87itacora/registro',
  ...
  const registrarPago = async (e) => {
    ...
    try {
      ...
      if (!pagoActual.cod_concepto) {
        try {
          const response = await axios.get('http://74.50.68.87aja/concepto/matricula');
      ...
      const response = await axios.post('http://74.50.68.87aja/pago', datosPago);
  ...
  useEffect(() => {
    const fetchDescuentos = async () => {
      try {
        const response = await axios.get('http://74.50.68.87aja/descuentos');
  ...
  const crearNuevaCaja = async () => {
    ...
    try {
      ...
      const response = await axios.post('http://74.50.68.87aja/oficial', datosCaja);
    ...
    const cargarNombreAlumno = async () => {
      try {
        ...
        const response = await axios.get(
          `http://74.50.68.87aja/nombre-alumno?cod_caja=${pagoActual.cod_caja}`
        );
...
const buscarCajasPorDni = async (dni) => {
  try {
    ...
    const url = `http://74.50.68.87aja/buscar-por-dni?dni=${dni}`;
...
useEffect(() => {
  const cargarValorMatriculaPorCaja = async () => {
    try {
      ...
      const response = await axios.get(
        `http://74.50.68.87aja/parametro/Matricula?cod_caja=${codCaja}`
      );
