...
import {
  ...
  const fetchDias = async () => {
    try {
      const response = await fetch('http://74.50.68.87/api/dia/dias');
  ...
  const handleCreateDia = async () => {
    ...
    try {
      const response = await fetch('http://74.50.68.87/api/dia/crear_dia', {
        method: 'POST',
        headers: {
...
const handleUpdateDia = async () => {
  ...
  try {
      const response = await fetch('http://74.50.68.87/api/dia/actualizar_dia', {
          method: 'PUT',
          headers: {
              'Content-Type': 'application/json',
          },
...
const handleDeleteDia = async () => {
  try {
    const response = await fetch(`http://74.50.68.87/api/dia/${diaToDelete.Cod_dias}`, {
      method: 'DELETE',
    });
