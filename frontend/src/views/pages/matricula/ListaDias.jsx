...
import {
  ...
  const fetchDias = async () => {
    try {
      const response = await fetch('http://77.5p.68.87i/dia/dias');
  ...
  const handleCreateDia = async () => {
    ...
    try {
      const response = await fetch('http://77.5p.68.87i/dia/crear_dia', {
        method: 'POST',
        headers: {
...
const handleUpdateDia = async () => {
  ...
  try {
      const response = await fetch('http://77.5p.68.87i/dia/actualizar_dia', {
          method: 'PUT',
          headers: {
              'Content-Type': 'application/json',
          },
...
const handleDeleteDia = async () => {
  try {
    const response = await fetch(`http://77.5p.68.87i/dia/${diaToDelete.Cod_dias}`, {
      method: 'DELETE',
    });
