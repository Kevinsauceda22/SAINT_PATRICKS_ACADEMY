...
<CDropdown className="btn-sm d-flex align-items-center gap-1 rounded shadow">
  ...
  >
    ...
    {/* Reporte PDF */}
    <CDropdownItem
      onClick={ReporteTipoContactoPDF}
      style={{
        cursor: 'pointer',
        outline: 'none',
        backgroundColor: 'transparent',
  ...
  <div className="d-flex justify-content-center gap-2">
    {canUpdate && (
      <CButton
        ...
        disabled={tipoContacto.estado === 0}
    ...
    <CButton
      style={{
        backgroundColor: tipoContacto.estado ? '#4CAF50' : '#F44336',
        color: 'white',
      }}
      onClick={() => toggleEstadoContacto(tipoContacto)}
      disabled={loading}
    >
