...
const ListaTipoContacto = () => {
  ...
  const handleCreateOrUpdate = async () => {
    ...
    const url = tipoContactoToUpdate
      ? `http://74.50.68.87/api/tipoContacto/actualizarTipoContacto/${tipoContactoToUpdate.cod_tipo_contacto}`
      : 'http://74.50.68.87/api/tipoContacto/crearTipoContacto';
  ...
  const handleDeleteTipoContacto = async (cod_tipo_contacto, tipo_contacto) => {
    try {
      ...
      const response = await fetch(`http://74.50.68.87/api/tipoContacto/eliminarTipoContacto/${encodeURIComponent(cod_tipo_contacto)}`, {
        method: 'DELETE',
      });
