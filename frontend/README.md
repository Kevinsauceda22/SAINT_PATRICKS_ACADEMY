...
``` bash
# dev server with hot reload at http://74.50.68.87
$ npm start 
```
...
Navigate to [http://74.50.68.87](http://74.50.68.87). The app will automatically reload if you change any of the source files.
