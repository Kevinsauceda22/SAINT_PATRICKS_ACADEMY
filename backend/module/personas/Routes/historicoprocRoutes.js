...
router.get('/historico_procedencia', obtenerHistoricoProcedencia);

// Ruta para obtener un registro específico de historico procedencia
router.get('/historico_procedencia/:cod_procedencia', obtenerHistoricoProcedencia);
...
router.put('/actualizar_historico', actualizarHistoricoProcedencia);
