...
export const validarValorActividad = async (req, res) => {
    const { Cod_ponderacion_ciclo, Cod_grados_asignaturas, Cod_parcial, Valor,Cod_secciones } = req.body;
    ...
    try {
        ...
        const [actividades] = await pool.query(
            ...
            WHERE a.Cod_ponderacion_ciclo = ?
              ...
              AND a.Cod_secciones = ?
            `,
            [Cod_ponderacion_ciclo, Cod_grados_asignaturas, Cod_parcial,Cod_secciones]
        );
...
export const validarYActualizarActividad = async (req, res) => {
    const { Cod_actividad_academica, Cod_ponderacion_ciclo, Cod_grados_asignaturas, Cod_parcial, Valor,Cod_secciones } = req.body;
    ...
    try {
        ...
        const [actividades] = await pool.query(
            ...
            [Cod_ponderacion_ciclo, Cod_grados_asignaturas, Cod_parcial, Cod_secciones, Cod_actividad_academica]
        );
