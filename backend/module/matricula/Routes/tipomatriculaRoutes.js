...
import {
    ...
    cambiarEstadoTipoMatricula, // 👈 AGREGA ESTA IMPORTACIÓN
...
router.put('/tipo-matricula/estado/:p_cod_tipo_matricula', cambiarEstadoTipoMatricula); // Activar o Inactivar un tipo de matrícula
